...
function ProductList({ onHomeClick }) {
    ...
    const totalQuantity = Array.isArray(CartItems) ? CartItems.reduce((total, item) => total + (item.quantity || 0), 0) : 0;
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}> 
                    ...
                    <div>
                        <a href="#" onClick={handleCartClick} style={styleA} aria-label="Open cart">
                            <div className="cart-icon" style={{ position: 'relative', display: 'inline-block' }}>
                                <h1 className="cart" style={{ margin: 0 }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68" fill="none">
                                        <rect width="156" height="156" fill="none"></rect>
                                        <circle cx="80" cy="216" r="12" fill="currentColor"></circle>
